...
public class TransitService {
	...
	public Location getCoordinates(String description) {
		...
		String url = geocodingUrl + description + "+GA&key=" + apiKey;
	...
	private double getDistance(Location origin, Location destination) {
		String url = distanceUrl + "origins=" + origin.lat + "," + origin.lng + "&destinations=" + destination.lat + "," + destination.lng + "&key=" + apiKey;
		System.out.println("Distance URL: " + url);
		RestTemplate restTemplate = new RestTemplate();
